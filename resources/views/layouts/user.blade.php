...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
    <a class="navbar-brand" href="{{url('layouts/usuario')}}">Gestión de Refugios</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a class="nav-link" href="{{url('refugios')}}">Refugios</a></li>
            <li class="nav-item"><a class="nav-link" href="{{url('organizaciones')}}">Organizaciones</a></li>
            <li class="nav-item"><a class="nav-link" href="#">Alertas</a></li>
            <li class="nav-item"><a class="nav-link" href="{{url('publicaciones')}}">Foros</a></li>
            <li class="nav-item"><a class="nav-link" href="{{url('perfil/edit')}}">Perfil</a></li>
...
<script>
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                <!--Contenido-->
                @if(Route::currentRouteName() === 'layouts.user')
                    <h3>¡Bienvenido! a la plataforma de refugios.</h3>
                @endif
